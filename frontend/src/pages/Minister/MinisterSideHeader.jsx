...
function MinisterSideHeader({ sidebarOpen }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center mb-6">
      ...
      >
        <div className="w-12 h-12 rounded-full overflow-hidden bg-amber-200 flex-shrink-0">
...
export default MinisterSideHeader;
