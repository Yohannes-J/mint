...
function StrategicSideHeader({ sidebarOpen }) {
  const dark = useThemeStore((state) => state.dark);

  return (
    <div className="flex flex-col items-center justify-center mb-6">
      <div className={`flex items-center gap-3 w-full mb-6 ${!sidebarOpen ? "justify-center" : ""}`}>
        ...
        <p className={`font-semibold transition-opacity ${!sidebarOpen ? "opacity-0 pointer-events-none" : ""} ${dark ? "text-white" : "text-gray-800"}`}>
...
export default StrategicSideHeader;
